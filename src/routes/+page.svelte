...
<div class="m-5 grid grid-cols-1 gap-4 md:grid-cols-3">
	<div class="grid grid-cols-1 gap-4 md:self-start">
		<div class="card card-border bg-base-100">
			<figure>
				<img src="/images/hero-banners/badges.avif" alt="Navigation badges" />
			</figure>
			<div class="card-body">
				<h2 class="card-title">Page Navigation</h2>
				<p>Jump to key pages and guides.</p>
				<div class="card-actions justify-end">
					<a class="btn btn-primary" href="/wiki/badges">View Badges</a>
				</div>
			</div>
		</div>
		...
		<div class="card card-border bg-base-100">
			<figure>
				<img src={updates} alt="Navigation updates" />
			</figure>
			<div class="card-body">
				<h2 class="card-title">Latest Updates</h2>
				<p>See new changes, balancing, and patch notes.</p>
				<div class="card-actions justify-end">
					<a class="btn btn-outline" href="/wiki/updates">Open Updates</a>
				</div>
			</div>
		</div>
		...
		<div class="card card-border bg-base-100">
			<figure>
				<img src={locations} alt="Navigation locations" />
			</figure>
			<div class="card-body">
				<h2 class="card-title">Facility Guide</h2>
				<p>Explore systems, locations, and operating basics.</p>
				<div class="card-actions justify-end">
					<a class="btn btn-outline" href="/wiki/facility">Open Guide</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="card card-border bg-base-100">
			...
			<div class="card-body">
				...
				<ul class="list-disc ml-5">
					...
					<li>Additional information added to SCRAM report</li>
					<li>Master mute restricted to Jr. Op+ -Added master mute logging</li>
		...
		<div class="card card-border bg-base-100">
			...
			<div class="card-body">
				...
				<p>
					...
					is a Roblox game developed by Koyot Digital. The game places you inside a power
					plant operating an
					<abbr
						title="Russian: high-power channel-type reactor, RBMK"
					>
						RBMK
					</abbr>
					-1500. Your goal: keep the facility stable, productive, and safe within a
					semi-realistic framework. You can play as an operator responsible for monitoring
					and managing all critical systems: the reactor core, turbines, cooling systems,
					backup systems, and more. Or play as a security officer and handle unauthorized
					personnel and detain operators causing mishaps. Every action matters, and a
					single mistake can trigger a chain reaction of problems. Oakridge aims to
					balance technical realism with accessibility, delivering an immersive experience
