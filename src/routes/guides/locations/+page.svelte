	...
	<div class="join join-vertical w-full">
		...
		<div class="collapse collapse-arrow join-item border-base-300 border">
			...
			<div class="collapse-content">
				...
				<p class="mb-4">The Control Room is the nerve center of the facility, with advanced consoles and monitoring systems.</p>
		...
		<div class="collapse collapse-arrow join-item border-base-300 border">
			...
			<div class="collapse-content">
				<ol class="list-decimal list-inside">
					...
					<li>Take either a left or right turn (Green door leads to Turbine B, Blue door leads to Turbine A)</li>
				</ol>
			</div>
		</div>
		...
		<div class="collapse collapse-arrow join-item border-base-300 border">
			<input type="radio" name="location-accordion" />
			<div class="collapse-title font-semibold">
				Steam Separators (and under the reactor)
			</div>
			<div class="collapse-content">
				<ol class="list-decimal list-inside">
					<li>While in the Staff Intake area, go through Plant Access A.</li>
